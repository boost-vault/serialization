...
// Permit friend to serialize bloom_filter.
...
namespace boost {
    namespace bloom_filters {
        template <typename Input, typename HashFunctions,
    ...
    namespace serialization {
        ...
        void serialize(
            Archive & ar,
            boost::bloom_filters::bloom_filter<Input, HashFunctions,
                                               Block, Allocator>& t,
    ...
    namespace bloom_filters {
        ...
        template <
            ...
            struct bloom_filter : protected detail::internals<Input, dynamic_bitset<Block,Allocator> > {
                template <class Archive, typename S_Input, typename S_HashFunctions,
                    typename S_Block, typename S_Allocator>
                friend void boost::serialization::serialize(
                    Archive & ar,
                    bloom_filter<S_Input, S_HashFunctions, S_Block, S_Allocator>& t,
                    const unsigned int version);
